...
7. [What about robots](07-what-about-robots.md), the one exception on this site: where I think this is going and what to get ready for, with the facts checked at the source and the belief labeled as belief.

## What this is not

Not a course. Not a product. There's no support line, and nobody's on call if it breaks for you. It's MIT licensed and offered as is: you can copy it, change it, and reuse any of it, and nobody is promising it will work exactly the way it worked for me.
...
## What this site counts, and why you should know it exists

Page views, per chapter, with a tool called GoatCounter. No cookies, no names, nothing stored about you. I use it to see which chapters get read and which ones people leave, and the numbers are public, same ones I see: [aiforappliancerepair.goatcounter.com](https://aiforappliancerepair.goatcounter.com).

I'm telling you because a lot of people don't know this kind of counting exists, and it runs the other direction too, on your own paperwork. When you email an invoice from QuickBooks with the "online invoice" option turned on, its status moves from Sent to Viewed the moment the customer opens it. An invoice that's been viewed and sits unpaid for a week is a different phone call from one that was never opened. Housecall Pro does the same when you email from it: it shows sent, delivered, opened, and how many times they opened it. That's in use in my shop every week; its help pages don't mention it, which is a reminder that the tool you run knows more than its manual. Nothing tells you which page of a PDF they read. And an "opened" can fire from an email preview nobody actually looked at, so treat it as a hint, not proof.
